        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-400 flex items-center gap-1.5 font-mono">
              <UserCheck className="w-4 h-4 text-emerald-400" /> Active Orgs &amp; Workspaces
            </h3>
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="bg-slate-950 border border-slate-900 rounded-xl p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="text-[9px] uppercase tracking-wider font-mono text-slate-500 font-bold block">CRYPTOGRAPHIC TENANT ENVELOPE</span>
              <h4 className="text-xs font-bold text-slate-200">
                Data Isolation status: <span className="text-emerald-400 font-extrabold uppercase font-mono">SECURE - ACTIVE</span>
              </h4>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-bold uppercase text-slate-400 tracking-wider flex items-center gap-2 font-mono">
                <ClipboardList className="w-4.5 h-4.5 text-emerald-400" /> Isolated System Logs Trail ({filteredLogs.length})
              </h3>
